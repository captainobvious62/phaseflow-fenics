...
def test_variable_viscosity__nightly():
    ...
    w, mesh = phaseflow.run(
        ...
        liquid_thermal_conductivity = 0.,
        solid_thermal_conductivity = 0.,
        ...
        initial_values_expression = (str(Re) + "*" + lid, "0.", "0.", "1. - 2.*(x[1] <= 0.)"),
        boundary_conditions = [
            {"subspace": 0, "value_expression": (str(Re), "0."), "degree": 3, 
                "location_expression": lid, "method": "topological"},
            {"subspace": 0, "value_expression": ("0.", "0."), "degree": 3, 
                "location_expression": fixed_walls, "method": "topological"},
            {"subspace": 1, "value_expression": "0.", "degree": 2, 
                "location_expression": left_middle, "method": "pointwise"}])
